...
export default function Strands({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("WebGL not supported or Renderer initialization failed", e);
      return;
    }
    ...
    function resize() {
      if (!ctn || !renderer || !program || !renderTarget || !glassProgram) return;
      const width = ctn.offsetWidth;
      const height = ctn.offsetHeight;
      renderer.setSize(width, height);
      
      const resVal = program.uniforms.uResolution.value;
      if (resVal && (resVal instanceof Float32Array || Array.isArray(resVal))) {
        resVal[0] = width;
        resVal[1] = height;
      }
      ...
      const glassResVal = glassProgram.uniforms.uResolution.value;
      if (glassResVal && (glassResVal instanceof Float32Array || Array.isArray(glassResVal))) {
        glassResVal[0] = width;
        glassResVal[1] = height;
      }
    }
