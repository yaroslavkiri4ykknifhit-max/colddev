...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    function handleMouseMove(e: MouseEvent) {
      if (!gl.canvas || !(gl.canvas instanceof HTMLCanvasElement)) return;
    ...
    function update(time: number) {
      ...
      if (enableMouseInteraction) {
        ...
        const mouseVal = program.uniforms.uMouse.value;
        if (mouseVal instanceof Float32Array || Array.isArray(mouseVal)) {
