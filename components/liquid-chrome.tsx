...
export const LiquidChrome: React.FC<LiquidChromeProps> = ({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      if (resUniform && (resUniform instanceof Float32Array || Array.isArray(resUniform))) {
    ...
    function handleMouseMove(event: MouseEvent) {
      ...
      if (mouseUniform && (mouseUniform instanceof Float32Array || Array.isArray(mouseUniform))) {
        mouseUniform[0] = x;
        mouseUniform[1] = y;
      }
    }
